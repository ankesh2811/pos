        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="main-content">
					...
					$a1 = mysqli_query($connection,"INSERT INTO products VALUES ('','$name','$product_price','$image1')");
                                    ...
                                    <div class="basic-form">
                                        <form role="form" method="POST" action="add-product.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_price" class="form-control input-rounded" placeholder="Product price">
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="card alert">
								...
								<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names..">
                                    <table class="table" id="myTable">
										...
										$i = '1';	
										$ii = '';
										$a2 = mysqli_query($connection,"SELECT * FROM products ORDER BY id DESC");
										while($a2_data = mysqli_fetch_array($a2))
										{
										$id = $a2_data['id'];
										$product_name = $a2_data['product_name'];
										$product_price = $a2_data['product_price'];
										$product_image = $a2_data['product_image'];
										...
										<td> <?php echo $ii; ?> </td>
                                           ...
                                           <td><a href="edit-product.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-info btn-rounded">Edit</button></a></td>
										    <td><a href="delete_product1.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-danger btn-rounded">Delete</button></a></td>
                                        </tr>
										<?php } ?>
