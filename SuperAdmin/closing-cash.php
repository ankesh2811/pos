                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card alert">
								...
								$a6 = mysqli_query($connection,"INSERT INTO closing_cash VALUES ('','$amount','$name','$date')");
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form role="form" method="POST" action="closing-cash.php" enctype="multipart/form-data"> 
                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <table class="table table-responsive">
										...
										$i = '1';	
										$ii = '';
										$a2 = mysqli_query($connection,"SELECT * FROM closing_cash ORDER BY date DESC");
