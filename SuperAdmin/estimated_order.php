       ...
       $N = count($item_name);
        ...
        for($i=0; $i < $N; $i++)
        {
		   ...
		   array_push($arr,$c);
            ...
            $q3 = mysqli_query($connection,"INSERT INTO order_mid_product VALUES ('','$m_id','$p_name','$p_price','$var2','$c',NOW())");
			if($q3)
			{
				echo 'Item Added';
				$c=0;
		...
		$a4 = mysqli_query($connection,"UPDATE orders_mid SET `amount`='$a',`status`='complete',`discount_price`='$c',`taxes`='$d' WHERE id='$m_id'");
  ...
  right: 10px;
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form role="form" method="POST" action="estimated_order.php" enctype="multipart/form-data">
										<div id="mybutton">
										<div class="col-lg-12">
	  ...
	  <div class="col-lg-4">
	  <div class="form-group">
                                               <button class="btn btn-warning btn-rounded btn-lg" onClick="printData();">Print</button>
                                            </div>
	  </div>
	  </div>
	  </div>
    ...
    margin-bottom: 12px; /* Add some space below the input */
                        ...
                        <div class="col-lg-12">
                            <?php 
								 ...
								 $a4 = mysqli_query($connection,"SELECT max(id) as m_id FROM orders_mid");
									  $a4_data = mysqli_fetch_array($a4);
									  $m_id = $a4_data['m_id'];
									
									  $a6 = mysqli_query($connection,"SELECT * FROM orders_mid WHERE id='$m_id'");
                            ...
                            <div class="card alert" >
								...
								<a href="generate-order.php?id=<?php echo $m_id; ?>" target="_blank"><button class="btn btn-info btn-rounded btn-lg">Generate Order</button></a>
								<hr>
        ...
        <td>
		  ...
		  <table border="1" width="100%">
										...
										$a1 = mysqli_query($connection,"SELECT * FROM order_mid_product WHERE order_id='$m_id' ORDER BY id DESC");
