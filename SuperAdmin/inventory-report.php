...
<head>
    ...
    <title>Thelewala : Inventory Report </title>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                               <div class="order-list-item" id="customers">
								...
								<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Item Name..">
                                    <table class="table" id="myTable">
										...
										$i = '1';	
										$ii = '';
										$a2 = mysqli_query($connection,"SELECT * FROM inventory ORDER BY date DESC");
										
										
										while($a2_data = mysqli_fetch_array($a2))
										{
										$purchase_bill = $a2_data['raw_name'];
										$purchase_vendor = $a2_data['raw_quantity'];
										$amount = $a2_data['date'];
