...
<?php  $pro_id = $_GET['q'];
		...
		$a1 = mysqli_query($connection,"SELECT product_quantity FROM order_mid_product WHERE order_id='$order_id' AND product_name='$product_name'");
		$a1_data = mysqli_fetch_array($a1);
		$c_id = $a1_data['product_quantity'];
