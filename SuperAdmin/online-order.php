...
<head>
    ...
    <title>Thelewala : Online Order </title>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Online Order</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /# column -->
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                           ...
                                           <td><button type="button" class="btn btn-success btn-rounded">Paid</button></td>
                                            <td><button type="button" class="btn btn-success btn-rounded">Delivered</button></td>
                                        ...
                                        <tr>
                                           ...
                                           <td><button type="button" class="btn btn-primary btn-rounded">Failed</button></td>
                                            <td><button type="button" class="btn btn-primary btn-rounded">Cancelled</button></td>
											<td><a href="view-order.php"><button type="button" class="btn btn-info btn-rounded">View</button></a></td>
                                        </tr>
