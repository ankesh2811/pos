                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
								...
								if(!empty(isset($_POST['submit'])))
								{
									...
									$date1 = $_POST['date1'];
									?>
									<form role="form" method="POST" action="product-count-report.php">
								...
								<button class="btn btn-lg btn-info" type="submit" name="submit">Get Report</button>
                                    ...
                                    <table class="table" id="myTable">
										...
										$i = '1';	
										$ii = '';
										$a2 = mysqli_query($connection,"SELECT DISTINCT(product_name) as p_name FROM order_product WHERE date BETWEEN '$date' AND '$date1'");
										
										
										while($a2_data = mysqli_fetch_array($a2))
										{
										$p_name = $a2_data['p_name'];
										$a3 = mysqli_query($connection,"SELECT count(id) as c_id FROM order_product WHERE product_name='$p_name' WHERE date BETWEEN '$date' AND '$date1'");
								...
								<button class="btn btn-lg btn-info" type="submit" name="submit">Get Report</button>
                                    ...
                                    <table class="table" id="myTable">
										...
										$i = '1';	
										$ii = '';
										$a2 = mysqli_query($connection,"SELECT DISTINCT(product_name) as p_name FROM order_product");
										...
										$a3 = mysqli_query($connection,"SELECT count(id) as c_id FROM order_product WHERE product_name='$p_name'");
										$a3_data = mysqli_fetch_array($a3);
										$c_id = $a3_data['c_id'];
