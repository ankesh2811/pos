...
<head>
    ...
    <title>Thelewala : Reward Point </title>
                            ...
                            <div class="card alert">
								...
								<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names..">
                                    <table class="table" id="myTable">
										...
										$i = '1';	
										$ii = '';
										$a2 = mysqli_query($connection,"SELECT * FROM reward_point ORDER BY date DESC");
										
										
										while($a2_data = mysqli_fetch_array($a2))
										{
										$contact_number = $a2_data['contact_number'];
										$points = $a2_data['points'];
										$date = $a2_data['date'];
