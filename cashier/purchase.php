                        ...
                        <div class="col-lg-9">
                            <div class="card alert">
                                <div class="card-header">
								   ...
								   $a1 = mysqli_query($connection,"INSERT INTO purchase VALUES ('','$bill_number','$vendor_name','$amount','$purchase_date','$mode')");
								   }
								   ?>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form role="form" method="POST" action="purchase.php" enctype="multipart/form-data"> 
											...
											<div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Mode of Payment</p>
                                               <select name="type" class="form-control input-rounded">
											   <option value="counter">Counter Cash</option>
											   <option value="owner">Owner Cash</option>
											   <option value="check">Check</option>
											   <option value="owner">NEFT</option>
											   <option value="owner">IMPS</option>
											   <option value="owner">Paytm</option>
											   </select>
                                            </div>
                                ...
                                <div class="card-body">
									...
									?>
                                            <tr>
                                                ...
                                                <td><a href="delete_purchase.php?id=<?php echo $p_id; ?>"><button class="btn btn-danger">Delete</button></a></td>
