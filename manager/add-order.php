                            ...
                            <div class="card alert">
                                <div class="card-header">
								   ...
								   if(isset($_POST['add_order']))
								   {
									  ...
									  $a2 = mysqli_query($connection,"INSERT INTO orders VALUES ('','$invoice','$table','$number','','$waiter',NOW(),'','$type','table','','','$discount','','')");
  ...
  right: 10px;
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form role="form" method="POST" action="add-order.php#alpha" enctype="multipart/form-data">
										<div id="mybutton">
										<div class="col-lg-12">
										<div class="col-lg-6">
    ...
    margin-bottom: 12px; /* Add some space below the input */
        ...
        <td>
          ...
          <table border="0" width="100%" >
            ...
            <tr>
              <td align="center"><nobr><?php echo date("d-m-y"); ?><time></nobr></td>
            </tr>
            <tr>
