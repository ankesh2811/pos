  ...
  right: 10px;
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form role="form" method="POST" action="edit-order.php#alpha?id=<?php echo $getid; ?>#alpha" enctype="multipart/form-data">
										<div id="mybutton">
										<div class="col-lg-12">
										<div class="col-lg-6">
	  ...
	  <div class="form-group">
                                            ...
                                            <div class="form-group">
											 ...
											 <div class="form-group">
                                                ...
                                                <input type="text" name="table" value="<?php echo $waiter; ?>" class="form-control input-rounded " placeholder="Table Number">
                                            </div>
